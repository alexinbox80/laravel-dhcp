...
return [
    ...
    */
    ...
    'connections' => [
        'oracle' => [
            'driver'         => 'oracle',
	        'tns'            => env('DB_ORACLE_TNS', '(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 10.65.0.13)(PORT = 1521))(CONNECT_DATA = (SERVER = DEDICATED)(SID = orcl11g)))'),
...
//            'driver' => 'pgsql',
//            'url' => env('DATABASE_URL'),
//            'host' => env('DB_HOST', '172.27.85.107'),
//            'port' => env('DB_PORT', '5433'),
//            'database' => env('DB_DATABASE', 'upmo'),
//            'username' => env('DB_USERNAME', 'case1'),
//            'password' => env('DB_PASSWORD', 'case1'),
//            'charset' => 'utf8',
//            'prefix' => '',
//            'prefix_indexes' => true,
//            'search_path' => 'laravel',
